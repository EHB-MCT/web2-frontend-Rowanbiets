/*!
 * jQuery Color Animations v07cdc1850d
...
(function (g, n) {
  ...
  function u(a) {
    ...
    return c.length ? ("0,0,0,0" === c.join() && g.extend(c, q.transparent), b) : q[a];
  }
  function r(a, b, c) {
    c = (c + 1) % 1;
  ...
  h.fn = g.extend(h.prototype, {
    parse: function (a, b, c, d) {
      if (a === n) return this._rgba = [null, null, null, null], this;
      if (a.jquery || a.nodeType) a = g(a).css(b), b = n;
      var f = this,
        e = g.type(a),
        j = this._rgba = [];
      ...
      if ("object" === e) return a instanceof h ? k(l, function (c, d) {
        a[d.cache] && (f[d.cache] = a[d.cache].slice());
      }) : k(l, function (d, c) {
        var b = c.cache;
        ...
        f[b] && 0 > g.inArray(null, f[b].slice(0, 3)) && (f[b][3] = 1, c.from && (f._rgba = c.from(f[b])));
      }), this;
    },
    is: function (a) {
      var b = h(a),
      ...
      k(l, function (a, e) {
        var j,
          g = b[e.cache];
        g && (j = d[e.cache] || e.to && e.to(d._rgba) || [], k(e.props, function (a, d) {
          if (null != g[d.idx]) return c = g[d.idx] === j[d.idx];
        }));
        return c;
      });
      return c;
    ...
    transition: function (a, b) {
      var c = h(a),
        ...
        j = e[f.cache] || f.to(e._rgba),
        g = j.slice(),
        c = c[f.cache];
      k(f.props, function (a, d) {
        var f = d.idx,
          e = j[f],
          h = c[f],
          k = t[d.type] || {};
        null !== h && (null === e ? g[f] = h : (k.mod && (h - e > k.mod / 2 ? e += k.mod : e - h > k.mod / 2 && (e -= k.mod)), g[f] = p((h - e) * b + e, d)));
      });
      return this[d](g);
    },
    blend: function (a) {
      ...
      var b = this._rgba.slice(),
        c = b.pop(),
        d = h(a)._rgba;
      return h(g.map(b, function (a, b) {
        return (1 - c) * d[b] + c * a;
      }));
    },
    toRgbaString: function () {
      var a = "rgba(",
        b = g.map(this._rgba, function (a, d) {
    ...
    toHslaString: function () {
      var a = "hsla(",
        b = g.map(this.hsla(), function (a, d) {
          null == a && (a = 2 < d ? 1 : 0);
  ...
  l.hsla.to = function (a) {
    ...
    var f = Math.max(b, c, d),
      ...
      g = f + e,
      h = 0.5 * g;
    return [Math.round(e === f ? 0 : b === f ? 60 * (c - d) / j + 360 : c === f ? 60 * (d - b) / j + 120 : 60 * (b - c) / j + 240) % 360, 0 === j ? 0 : 0.5 >= h ? j / g : j / (2 - g), h, null == a ? 1 : a];
  };
  ...
  k(l, function (a, b) {
    ...
    h.fn[a] = function (a) {
      ...
      var b,
        s = g.type(a),
        l = "array" === s || "object" === s ? a : arguments,
        m = this[d].slice();
      k(c, function (a, d) {
      ...
      return e ? (b = h(e(m)), b[d] = m, b) : h(m);
    };
    k(c, function (d, b) {
      h.fn[d] || (h.fn[d] = function (c) {
        var e = g.type(c),
          f = "alpha" === d ? this._hsla ? "hsla" : "rgba" : a,
          h = this[f](),
          k = h[b.idx];
        if ("undefined" === e) return k;
        "function" === e && (c = c.call(this, k), e = g.type(c));
  ...
  h.hook = function (a) {
    ...
    k(a, function (a, c) {
      ...
      g.fx.step[c] = function (a) {
        a.colorInit || (a.start = h(a.elem, c), a.end = h(a.end), a.colorInit = !0);
        g.cssHooks[c].set(a.elem, a.start.transition(a.end, a.pos));
      };
    });
  };
